...
$(function() {
	$('#grid').datagrid({   
	    ...
	    columns : [[ {width : '50', field : 'ck',checkbox:true},
	                 {width : '150',title : '字典名称',field : 'dictName',sortable:true},
	                 {width : '150',title : '字典描述',field : 'dictDesc',sortable:true},
	                 ...
	                 {width : '80',title : '操作',field : 'action',sortable:true,formatter:function(value,row){
