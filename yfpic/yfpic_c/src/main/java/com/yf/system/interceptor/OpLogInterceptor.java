...
import com.yf.system.shiro.SpringSecurityUtils;
import com.yf.system.web.Globals;
...
public class OpLogInterceptor extends HandlerInterceptorAdapter {
	...
	public void afterCompletion(HttpServletRequest request,
		...
		Method method = handlerMethod.getMethod();
			...
			sysLog.setProcessTime(Long.valueOf(processTime+""));
			sysLog.setUserIp(rip);
			SysUser sysUser = SpringSecurityUtils.getCurrentUser();
			sysLog.setUserId((long)sysUser.getUserId());
			sysLog.setUserName(sysUser.getUserName());
			logger.info("################OpLogInterceptor rip = {},url = {},method = {}",rip,url,method.getName());
